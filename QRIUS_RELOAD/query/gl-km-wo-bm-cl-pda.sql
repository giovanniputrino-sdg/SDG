...
CASE WHEN WO.SITEID LIKE '%BM%' THEN 'http://ix1gmarsprd.am.lilly.com/maximo/ui/maximo.jsp?event=loadapp&value=wotrack&additionalevent=sqlwhere&additionaleventvalue=WONUM%3D'''||WO.WONUM||'''&forcereload=true'
WHEN WO.SITEID LIKE '%CL%' THEN 'http://ix1gmarsprdc2.am.lilly.com/maximo/ui/maximo.jsp?event=loadapp&value=wotrack&additionalevent=sqlwhere&additionaleventvalue=WONUM%3D'''||WO.WONUM||'''&forcereload=true'
WHEN WO.SITEID IS NULL THEN ''
ELSE ''
END AS url,
CASE WHEN WO.SITEID LIKE '%BM%' THEN 'ix1gmarsprd.am.lilly.com'
WHEN WO.SITEID LIKE '%CL%' THEN 'ix1gmarsprdc2.am.lilly.com'
WHEN WO.SITEID IS NULL THEN ''
ELSE ''
END AS lbl_url,
...
CASE WHEN WO.SITEID LIKE '%BM%' THEN 'Brazil'
WHEN WO.SITEID LIKE '%CL%' THEN 'Clinton'
...
ELSE 'n.a.'
END AS ref_site,
CASE WHEN WO.SITEID LIKE '%BM%' THEN 'Dry'
WHEN WO.SITEID LIKE '%CL%' THEN 'Elanco'
WHEN WO.SITEID IS NULL THEN 'n.p.'
ELSE 'n.a.'
END AS lbl_network,
CASE WHEN WO.SITEID LIKE '%BM%' THEN 'Dry'
