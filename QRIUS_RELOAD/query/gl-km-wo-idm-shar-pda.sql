...
CASE WHEN WO.SITEID LIKE '%IDM%' THEN 'IDM'
WHEN WO.SITEID LIKE '%SHARSERV%' THEN 'Central'
...
ELSE 'n.a.'
END AS ref_site,
CASE WHEN WO.SITEID LIKE '%IDM%' THEN 'Parenteral'
WHEN WO.SITEID LIKE '%SHARSERV%' THEN 'Other'
WHEN WO.SITEID IS NULL THEN 'n.p.'
ELSE 'n.a.'
END AS lbl_network,
CASE WHEN WO.SITEID LIKE '%IDM%' THEN 'Parenteral'
...
AND (WO.SITEID LIKE '%IDM%' OR WO.SITEID LIKE '%SHARSERV%')
) A
limit 1000