...
CASE WHEN WO.SITEID LIKE '%P5%' THEN 'PR05'
WHEN WO.SITEID LIKE '%ZH%' THEN 'China'
...
ELSE 'n.a.' 
END AS ref_site,
CASE WHEN WO.SITEID LIKE '%ZH%' THEN 'Dry'
WHEN WO.SITEID LIKE '%P5%' THEN 'API'
WHEN WO.SITEID IS NULL THEN 'n.p.'
ELSE 'n.a.'
END AS lbl_network,
CASE WHEN WO.SITEID LIKE '%ZH%' THEN 'Dry'
...
AND (WO.SITEID LIKE '%ZH%' OR WO.SITEID LIKE '%P5%')